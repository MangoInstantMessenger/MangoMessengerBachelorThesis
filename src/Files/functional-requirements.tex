\textbf{Functional requirements.} Mostly common and simple way to define software product's functional requirements is User Stories.
...
\subsection{Managing profile settings user stories}\label{subsec:profile-settings-user-stories}
\begin{itemize}
