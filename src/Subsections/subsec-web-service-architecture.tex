...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Pictures/04_Service_entity_concept_diagram}~\caption{Service entity concept diagram. Source: [\cite{fowler2011cqrs}].}\label{fig:figure9}
\end{figure}
Where the steps are
\begin{enumerate}
