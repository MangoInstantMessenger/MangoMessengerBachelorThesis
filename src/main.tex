...
% Uncomment the lines as you write the chapters
    \include{Chapters/01_Main_Aim_Of_The_Work}
    \include{Chapters/02_Introduction}
    \include{Chapters/03_System_Requirements}
    \include{Chapters/04_Architectural_aspects}
    \include{Chapters/05_Authentication_and_authorization}
    \include{Chapters/06_Security_of_communication_channel}
    \include{Chapters/07_User_interface}
