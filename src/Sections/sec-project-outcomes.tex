...
%    \textit{"As an authorized user, I want to search public groups by title so that I enter display name to specified field,
%    click button "Search chats" and see results."}
%    \textit{"As a registered user, I want to join public groups so that
%    I click button "Join group"to join the group."}
    \begin{itemize}
...
%        \textit{"As registered user, I want to tap "Leave" so that I leave from specified chat or channel."}
%    \textit{"As a registered user, I want to tap "Archive" so that I archive the specified chat or channel."}
%    \textit{"As a registered user, I want to tap "Un-archive" so that I un-archive the specified archived chat or channel."}
    \begin{itemize}
...
%    \textit{"As an authorized user, I want to tap "Edit" on my message so that other members of the group see the message I edited."},
%    \textit{"As an authorized user, I want to tap "Delete" on my message so that my message is deleted for all members of the group."}
    \begin{itemize}
