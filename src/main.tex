...
\AddToShipoutPictureBG{
    \AtPageUpperLeft{
        \raisebox{-2\height}{
            \hspace*{6.8cm}\includegraphics[height=1.2cm]{Pictures/wsb_logo}
        }
    }
}
%----------------------------------------------------------------------------------------
...
\subject{Computer science, cryptography, realtime communications} % Your subject area, this is not currently used anywhere in the template, print it elsewhere with \subjectname
\keywords{Instant messaging system, IMS, JWT authorization, Diffie-Hellman, E2E encryption, CQRS, .NET, dotnet} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
...
% Uncomment the lines as you write the chapters
    \include{Chapters/ch-partner-details}
    \include{Chapters/ch-project-assumptions}
...
% Uncomment the lines as you write the Appendices
    ...
    \include{Appendices/annex-functional-requirements}
    \include{Appendices/annex-non-functional-requirements}
%    \include{Appendices/annex-rsa-algorithm}
%    \include{Appendices/annex-azure-deploy-via-actions}
