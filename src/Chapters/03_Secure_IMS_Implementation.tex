...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{UserPersonalInformation.}
    \begin{itemize}
        ...
        \item ProfilePicture IMAGE -- Avatar of user.
    \end{itemize}
    \item \textbf{UserContacts.}
    \begin{itemize}
        \item ContactId VARCHAR(36) -- User id from contact, Guid.
        \item UserId VARCHAR(36) -- User id from current user, Guid.
    \end{itemize}
    ...
    \end{itemize}
    \item \textbf{Chat Info.}
    \begin{itemize}
        \item Id VARCHAR(36) -- Id of the chat information, Guid.
    ...
    \item \textbf{Messages.}
    \begin{itemize}
        \item Id VARCHAR(36) -- Id of the message, Guid.
        \item ChatId VARCHAR(36) -- Foreign key to the Chats table, Guid.
        \item UserId VARCHAR(36) -- Foreign key to the Users table, Guid.
        \item Content VARCHAR -- Content of the message
        \item IsRead BOOLEAN -- %%Fill
        \item CreateAt DATETIME -- Time when the message was created
        \item UpdatedAt DATETIME -- Time when the message was updated
    \end{itemize}
    \item \textbf{Refresh Tokens.}
    \begin{itemize}
        \item Id VARCHAR(36) -- Id of the token, Guid.
        \item UserId VARCHAR(39) -- Foreign key to the Users table, Guid.
        \item RefreshToken VARCHAR(60) -- Refreshed access token, using for authorization.
        \item Expires DATETIME -- Expiration date of refresh token
        \item CreatedAt DATETIME -- Date when token was created
    \end{itemize}
\end{itemize}
