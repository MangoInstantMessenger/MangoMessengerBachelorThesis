...
\begin{figure}[H]
    ...
    \caption{Relation between system complexity and architectures [\cite{fowler2015microsevices}].}
...
\begin{figure}[H]
    ...
    \caption{Service entity concept diagram [\cite{fowler2011cqrs}].}\label{fig:figure9}
\end{figure}
Where the steps are
\begin{enumerate}
...
\begin{figure}[H]
    ...
    \caption{CQRS concept diagram [\cite{fowler2011cqrs}].}
    \label{fig:figure}
\end{figure}
