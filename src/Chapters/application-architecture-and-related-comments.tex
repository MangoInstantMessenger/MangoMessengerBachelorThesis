...
\begin{itemize} % source: https://en.wikipedia.org/wiki/Multitier_architecture#cite_note-5
    ...
    \item \textbf{Application Logic.} Service layer [INSERTREF] [INSERTREF] or GRASP Controller Layer [INSERTREF].
...
For example, in a relaxed layered system (as opposed to a strict layered system) a layer can also depend on all
the layers below it [INSERTREF].
...
\begin{itemize}
    ...
    communications using IPC [INSERTREF] or other mechanisms.
...
Mediator -- is a behavioral design pattern [INSERTREF] that lets you reduce chaotic dependencies between objects.
...
transmitting information between parties as a JSON object [INSERTREF].
This information can be verified and trusted because it is digitally signed.
JWTs can be signed using a secret (with the HMAC algorithm [INSERTREF]) or a public/private key pair using RSA or ECDSA.
