...
\begin{itemize}
    \item As an authorized user, I want navigation about pages so that I can navigate to the contacts and personal
    information page from main page and vice versa.
\end{itemize}
...
\begin{itemize}
    ...
    \item As an authorized user, I want save my updated personal information so that users will see it.
\end{itemize}